...
conv3 = dict(init=init_gen, batch_norm=True, activation=Logistic(), padding=pad3, strides=str3)
G_layers = [
...
On 3 August 2017 at 16:21, Elena Orlova <egorlova68@gmail.com> wrote:
import os
from datetime import datetime
from neon.callbacks.callbacks import Callbacks, GANCostCallback
#from neon.callbacks.plotting_callbacks import GANPlotCallback
